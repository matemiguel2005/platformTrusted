...
public class PlatformTrustedApp {

    private static final Logger log = LoggerFactory.getLogger(PlatformTrustedApp.class);

    private final Environment env;

    public PlatformTrustedApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes platformTrusted.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PlatformTrustedApp.class);
